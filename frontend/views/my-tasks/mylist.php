    ...
    <div class="main-container page-container">
        <section class="menu-toggle">
            <ul class="menu-toggle__list">
                <li class="menu-toggle__item <?= Yii::$app->request->get('status') == Tasks::STATUS_DONE ? 'menu_toggle__item--current' : '' ?> menu-toggle__item--completed">
                ...
                <li class="menu-toggle__item <?= Yii::$app->request->get('status') == Tasks::STATUS_NEW ? 'menu_toggle__item--current' : '' ?> menu-toggle__item--new">
                    ...
                    <?= Html::a('Новые', ['my-tasks/index', 'status' => Tasks::STATUS_NEW])?>
                </li>
                <?php endif; ?>
                <li class="menu-toggle__item <?= Yii::$app->request->get('status') == Tasks::STATUS_IN_WORK ? 'menu_toggle__item--current' : '' ?> menu-toggle__item--active">
                    <div class="menu-toggle__svg-wrapper">
                    ...
                    <?= Html::a('Активные', ['my-tasks/index', 'status' => Tasks::STATUS_IN_WORK])?>
                </li>
                <li class="menu-toggle__item <?= Yii::$app->request->get('status') == Tasks::STATUS_CANCEL ||
                   Yii::$app->request->get('status') == Tasks::STATUS_FAILED
                    ? 'menu_toggle__item--current' : '' ?> menu-toggle__item--canceled">
                    <div class="menu-toggle__svg-wrapper">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <?= Html::a('Отмененные', ['my-tasks/index', 'status' => [Tasks::STATUS_CANCEL, Tasks::STATUS_FAILED]])?>
                </li>
                <li class="menu-toggle__item <?= Yii::$app->request->get('status') == Tasks::STATUS_OVERDUE ? 'menu_toggle__item--current' : '' ?> menu-toggle__item--hidden">
                    <div class="menu-toggle__svg-wrapper">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <?= Html::a('Просроченные', ['my-tasks/index', 'status' => Tasks::STATUS_OVERDUE])?>
                </li>
            </ul>
        </section>
